var lt=Object.defineProperty;var Y=o=>{throw TypeError(o)};var dt=(o,e,t)=>e in o?lt(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var f=(o,e,t)=>dt(o,typeof e!="symbol"?e+"":e,t),R=(o,e,t)=>e.has(o)||Y("Cannot "+t);var p=(o,e,t)=>(R(o,e,"read from private field"),t?t.call(o):e.get(o)),w=(o,e,t)=>e.has(o)?Y("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(o):e.set(o,t),O=(o,e,t,n)=>(R(o,e,"write to private field"),n?n.call(o,t):e.set(o,t),t),g=(o,e,t)=>(R(o,e,"access private method"),t);var nt=(o=>(o.AutoClose="autoClose",o.closeButton="closeButton",o.Duration="duration",o.Title="title",o.Message="message",o.Position="position",o.Variant="variant",o))(nt||{}),v=(o=>(o.Error="error",o.Info="info",o.Default="default",o.Loading="loading",o.Success="success",o.Warning="warning",o))(v||{}),i=(o=>(o.TopRight="top-right",o.TopLeft="top-left",o.BottomRight="bottom-right",o.BottomLeft="bottom-left",o))(i||{});const ut=`* {
...
`,D=` <svg
  ...
  >
    ...
    `}set options(t){var a;Object.entries(t).forEach(([r,c])=>this[r]=c);const n=document.createElement("template");n.innerHTML=this.template,(a=this.shadowRoot)==null||a.appendChild(n.content.cloneNode(!0))}connectedCallback(){var t,n;(t=this.shadowRoot)!=null&&t.isConnected&&(this.closeButton&&((n=this.button)==null||n.addEventListener("click",a=>g(this,h,T).call(this,a))),this.autoClose&&g(this,h,_).call(this),p(this,z).call(this))}disconnectedCallback(){var t;this.closeButton&&((t=this.button)==null||t.removeEventListener("click",n=>g(this,h,T).call(this,n))),this.autoClose&&p(this,b)&&clearTimeout(p(this,b))}close(){g(this,h,T).call(this)}update(t){var u,L,m,q,X,$,V,A,I,j,W;const{autoClose:n,closeButton:a,duration:r,title:c,message:s,variant:d}=t||{};if(r&&this.duration!==r&&(this.duration=r,this.autoClose&&((L=(u=this.shadowRoot)==null?void 0:u.querySelector(".toastive__progress"))==null||L.animate([{width:"100%"},{width:"0%"}],{duration:this.duration,easing:"linear",fill:"forwards"}))),s&&this.message!==s){const l=(m=this.shadowRoot)==null?void 0:m.querySelector("slot[name='message']");l.innerHTML=s,this.message=s}if(c&&this.title!==c){const l=(q=this.shadowRoot)==null?void 0:q.querySelector("slot[name='title']");l.innerHTML=c,this.title=c}if(n&&this.autoClose!==n&&(($=(X=this.shadowRoot)==null?void 0:X.querySelector(".toastive"))==null||$.appendChild(document.createElement("div")).classList.add("toastive__progress"),g(this,h,_).call(this),this.autoClose=n),d&&this.variant!==d){(A=(V=this.shadowRoot)==null?void 0:V.querySelector(".toastive"))==null||A.classList.replace(this.variant,d);const l=(I=this.shadowRoot)==null?void 0:I.querySelector("slot[name='icon']");if(l){const S=p(this,k).call(this,d);l.innerHTML="",S&&(l.innerHTML=S)}this.variant=d}if(a&&this.closeButton!==a){const l=document.createElement("button");l.id="toastive__close",l.classList.add("toastive__close"),l.innerHTML=D,(W=(j=this.shadowRoot)==null?void 0:j.querySelector(".toastive"))==null||W.appendChild(l),l.addEventListener("click",S=>g(this,h,T).call(this,S)),this.closeButton=a}}}b=new WeakMap,h=new WeakSet,_=function(){var n;const t=(n=this.shadowRoot)==null?void 0:n.querySelector(".toastive__progress");t==null||t.animate([{width:"100%"},{width:"0%"}],{duration:this.duration,easing:"linear",fill:"forwards"}),O(this,b,setTimeout(()=>{g(this,h,T).call(this)},this.duration))},T=function(t){t==null||t.stopPropagation(),this.animate([{transform:"translateY(0%)",opacity:1},{transform:this.position===i.TopRight||this.position===i.TopLeft?"translateY(-100%)":"translateY(100%)",opacity:0}],{duration:300,easing:"ease-in-out",fill:"forwards"}).onfinish=()=>{p(this,E).call(this)}},k=new WeakMap,E=new WeakMap,z=new WeakMap;customElements.define("mm-toastive",at);const gt=`* {
	box-sizing: border-box;
}
...
`;var M,st;class rt extends HTMLElement{constructor(){super();w(this,M);this.attachShadow({mode:"open"})}get template(){return`
...
}`,...(U=(N=y.parameters)==null?void 0:N.docs)==null?void 0:U.source}}};var F,G,J;x.parameters={...x.parameters,docs:{...(F=x.parameters)==null?void 0:F.docs,source:{originalSource:`() => createButtonToShowToastive({
  title: 'Toastive',
  ...
  duration: 5000,
  closeButton: false
}, 'Show Toastive')`,...(J=(G=x.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};var K,Q,Z;C.parameters={...C.parameters,docs:{...(K=C.parameters)==null?void 0:K.docs,source:{originalSource:`() => createButtonToShowToastive({
  title: 'Toastive',
  message: '👋 Hi from top-right corner!',
  position: ToastivePosition.TopRight,
  variant: ToastiveVariant.Success,
  autoClose: false,
  closeButton: true
}, 'Show Toastive')`,...(Z=(Q=C.parameters)==null?void 0:Q.docs)==null?void 0:Z.source}}};var tt,ot,et;B.parameters={...B.parameters,docs:{...(tt=B.parameters)==null?void 0:tt.docs,source:{originalSource:`() => {
  const showToast = () => {
  ...
  createButton.addEventListener('click', showToast);
  return createButton;
}`,...(et=(ot=B.parameters)==null?void 0:ot.docs)==null?void 0:et.source}}};const bt=["playground","propsExample","closeButtonExample","updatedPropsExample"],wt=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:bt,closeButtonExample:C,default:ct,playground:y,propsExample:x,updatedPropsExample:B},Symbol.toStringTag,{value:"Module"}));export{wt as T,C as c,x as p,B as u};
